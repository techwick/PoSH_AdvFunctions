...
if ($VMAlreadyExists) {
    Add-Content -Path 'C:\Users\techwick\Desktop\Pluralsight\Powershell\powershell-modules-advanced-functions-building\1-powershell-modules-advanced-functions-building-m1-exercise-files\somelogfile.log' -Value "WARNING: $VMAlreadyExists"
}

New-VirtualMachine -VMName 'SQLInjectAttackName' -ErrorVariable err
if ($err) {
    Add-Content -Path 'C:\Users\techwick\Desktop\Pluralsight\Powershell\powershell-modules-advanced-functions-building\1-powershell-modules-advanced-functions-building-m1-exercise-files\somelogfile.log' -Value "ERR: $($err.Exception.Message)"
}

## Check out the log
Get-Content -Path 'C:\Users\techwick\Desktop\Pluralsight\Powershell\powershell-modules-advanced-functions-building\1-powershell-modules-advanced-functions-building-m1-exercise-files\somelogfile.log'
